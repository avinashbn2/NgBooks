...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__movie_list_movie_list_component__ = __webpack_require__("../../../../../src/app/movie-list/movie-list.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__movie_list_movie_list_component__["a" /* MovieListComponent */],
...
module.exports = " <div class=\"row movie-list\">\n   \n <div class=\"card col-md-3\" *ngFor=\"let movie of movies\">\n   <h3 class=\"card-header\">{{movie.name}}    \n    <i (click)=\"toggleFavourite(movie)\" class=\"fa fa-heart favourite\"  \n    [ngStyle]=\"movie.favourite && {'color': 'red'}\" ></i>\n</h3>\n   <img height=\"400\" src=\"../../assets/{{movie.image}}\"/>\n  <div class=\"card-body\">\n      <i [ngClass]=\"1==1?'favourite':'blue'\">Hello {{name}}</i>\n\n    <h5 class=\"card-title\" >{{movie.description}}</h5>\n    <h6 class=\"card-subtitle text-muted\">{{movie.description}}</h6>\n  </div>\n </div>\n\n </div>"
...
var MovieListComponent = /** @class */ (function () {
    ...
    MovieListComponent.prototype.toggleFavourite = function (movie) {
        console.log(this.movies);
...
var MovieService = /** @class */ (function () {
    ...
    MovieService.prototype.getMovieData = function () {
        return this.http.get('../../assets/data.json')
            ...
            .catch(function (err) { console.log(err); return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].throw(err); });
    };
